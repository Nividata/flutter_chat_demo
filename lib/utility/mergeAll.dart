...
extension MergeAllExtension<T> on Stream<T> {
  ...
  ///         .listen(print); // prints 2, 1
  Stream<T> mergeAllWith(Iterable<Stream<T>> streams) {
    final stream = MergeAllStream<T>([this, ...streams]);
